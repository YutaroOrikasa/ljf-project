...
#define LJF_INIT_PLACE_HOLDER(name) \
    ...
    // ParserPlaceHolder<Stmt> LJF_INIT_PLACE_HOLDER(testlist_star_expr);
    ...
    // ParserPlaceHolder<ImportStmt> LJF_INIT_PLACE_HOLDER(dotted_as_names);
    // ParserPlaceHolder<Stmt> LJF_INIT_PLACE_HOLDER(dotted_name);
    // ParserPlaceHolder<Stmt> LJF_INIT_PLACE_HOLDER(global_stmt);
    // ParserPlaceHolder<Stmt> LJF_INIT_PLACE_HOLDER(nonlocal_stmt);
    // ParserPlaceHolder<Stmt> LJF_INIT_PLACE_HOLDER(assert_stmt);
